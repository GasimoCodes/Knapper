...
namespace Knapper
{
	...
	internal class Program
	{
		...
		public static Vector2[] KnapsackSolver(Vector2[] list, int capacity)
		{
			...
			Console.WriteLine("Compute: Weight: " + resultValues[bestResultIndex].X + " Value: " + resultValues[bestResultIndex].Y);
		...
		private static bool[] KnapsackSolverThreaded(Vector2[] list, int capacity)
		{
			...
			Console.WriteLine("Threaded: Weight: " + bestResult.X + " Value: " + bestResult.Y);
